# Examples.Analyzer.Roslyn.Demo

## Overview and Purpose

This project includes a sample that uses the code generator from `Examples.Analyzer.Roslyn`.
...
- `make-const`: Runs the `MakeConstAnalyzer sample` sample
