...
using Examples.Tests.System.Composition.Fixtures.MyServices;
...
public partial class CompositionHostTests
{
    ...
    public void WhenMultipleServicesRegisteredWithSameInterface_ReturnsAsIEnumerable()
    {
        ...
        mock.Setup(x => x.Print("Hello MEF2 DI world 1st."));
        mock.Setup(x => x.Print("Hello MEF2 DI world 2nd."));
        mock.Setup(x => x.Print("Hello MEF2 DI world 3rd."));
        ...
        mock.Verify(x => x.Print("Hello MEF2 DI world 1st."), Times.Exactly(2));
        mock.Verify(x => x.Print("Hello MEF2 DI world 2nd."), Times.Exactly(2));
        mock.Verify(x => x.Print("Hello MEF2 DI world 3rd."), Times.Exactly(2));
