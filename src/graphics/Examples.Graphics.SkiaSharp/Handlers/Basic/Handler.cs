...
namespace Examples.Graphics.SkiaSharp.Handlers.Basic;
...
public class Handler : IHandler
{
    public Task<int> HandleAsync(IHandler.Parameter parameter, CancellationToken cancellationToken)
    {
        ...
        using var typeface = FontResolver.FromFamilyName("sans-serif");
        using var font = new SKFont() { Typeface = typeface, Size = width * 0.10f };
