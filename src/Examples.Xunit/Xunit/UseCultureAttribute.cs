...
/// </summary>
/// <seealso href="https://github.com/xunit/samples.xunit/blob/main/UseCulture/UseCultureAttribute.cs"/>
...
public class UseCultureAttribute : BeforeAfterTestAttribute
{
    ...
    {
        Thread.CurrentThread.CurrentCulture = culture ?? throw new ArgumentNullException(nameof(culture));
        Thread.CurrentThread.CurrentUICulture = uiCulture ?? throw new ArgumentNullException(nameof(uiCulture));
