...
namespace Examples.Fluency.Extensions;

/// <summary>
/// extension methods for converting strings to <see cref="Index" /> and <see cref="Range" /> values.
/// </summary>
public static partial class TypeConvertorStringExtensions
{
    ...
    public static Index ToIndex(this string value)
    {
